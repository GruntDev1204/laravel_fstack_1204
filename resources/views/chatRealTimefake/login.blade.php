...
<body style="background-color: rgb(61, 60, 60)">
    <div id="loginUser" class="container mt-5">
        <div class="alert alert-info" style="border-radius: 20px">
                <div class="form-group">
                    <label for="exampleInputEmail1">Phone Number</label>
                    <input v-model="arrayLogin.sdt" type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
                  </div>
                <div class="form-group">
                  <label for="exampleInputPassword1">Password</label>
                  <input type="password"  v-model="arrayLogin.password" class="form-control" id="exampleInputPassword1">
                </div>
                <button type="submit"  v-on:click="loginUser()" class="btn btn-primary">login</button>
        </div>
    </div>
</body>
<script src="/chatSever/login.js"></script>
